...
import { NavLink } from 'react-router-dom'; // Ampio ity
import { 
...
const Sidebar = () => {
  // Nampiana 'path' mifanaraka amin'ny pejy tsirairay
  const menuItems = [
  ...
  return (
    <aside className="w-72 hidden md:flex flex-col p-3 bg-white dark:bg-slate-950 border-r border-slate-100 dark:border-slate-800 transition-colors">
      ...
      <div className="mt-auto pb-2">
        <button 
          onClick={() => {/* Fonctions de déconnexion */}}
      ...
      <div className="p-4 border-t border-slate-100 dark:border-slate-800">
        <p className="text-[10px] text-slate-400 font-bold tracking-widest text-center">
